# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2017-01-20 17:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_activation_key', models.CharField(blank=True, editable=False, max_length=200, null=True)),
                ('created_at', models.IntegerField(blank=True, default=0, editable=False)),
                ('updated_at', models.IntegerField(default=0, editable=False)),
                ('profile_apiuser', models.OneToOneField(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Profile_User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'User',
